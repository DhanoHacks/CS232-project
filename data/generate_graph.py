...
def plot_llc_size():
    ...
    plt.ylabel("LLC MPKI")
    plt.xlabel("Trace")
    plt.title("LLC MPKI vs LLC SIZE (MB) for various trace")
    plt.legend()
...
def plot_l2_size():
    ...
    plt.ylabel("LLC MPKI")
    plt.xlabel("Trace")
    plt.title("LLC MPKI vs L2 SIZE (MB) for various trace")
    plt.legend()
...
def plot_repl(inclusivity):
    ...
    plt.ylabel("LLC MPKI")
    plt.xlabel("Trace")
    plt.title(f"LLC MPKI vs Replacement Policy for various traces using {inclusivity} Cache Hierarchy")
    plt.legend()
...
def plot_incl():
    ...
    plt.ylabel("LLC MPKI")
    plt.xlabel("Trace")
    plt.title("LLC MPKI vs Cache Inclusion Policy for various traces")
    plt.legend()
...
def plot_block():
    ...
    plt.ylabel("LLC MPKI")
    plt.xlabel("Trace")
    plt.title("LLC MPKI vs Block Size for various traces")
    plt.legend()
...
def plot_best_result():
    ...
    plt.ylabel("LLC MPKI")
    plt.xlabel("Trace")
    plt.title("Best cache hierarchy for various traces (LLC MPKI)")
    plt.legend()
